import { ArrowRight, Menu, X, ChevronDown, Shield, Cloud, Cpu, Database, TrendingUp, Award, Users, CheckCircle, Mail, Phone, Linkedin, Twitter, Github } from "lucide-react"
  ...
  const caseStudies = [
    {
      ...
      result: "40% cost reduction through cloud migration",
      metric: "99.99% uptime achieved"
    },
    {
      company: "HealthCare Network",
      industry: "Healthcare",
      result: "HIPAA-compliant infrastructure in 60 days",
      metric: "Zero security incidents"
    },
    {
      company: "Manufacturing Corp",
      industry: "Manufacturing",
      result: "IoT integration improved efficiency by 35%",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-violet-50">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              <a href="#careers" className="text-gray-700 hover:text-purple-600 font-medium transition-colors">
                Careers
              </a>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {servicesOpen && (
                    <div className="pl-4 mt-2 space-y-2">
                      {services.map((service) => (
                        <a key={service.name} href="#services" className="block py-2 text-gray-600 hover:text-purple-600">
                          {service.name}
                        </a>
                      ))}
                    </div>
                ...
                <div>
                  ...
                  {industriesOpen && (
                    <div className="pl-4 mt-2 space-y-2">
                      {industries.map((industry) => (
                        <a key={industry} href="#industries" className="block py-2 text-gray-600 hover:text-purple-600">
                          {industry}
                        </a>
                      ))}
                    </div>
                ...
                <a href="#about" className="block font-semibold text-gray-900 py-2">About Us</a>
                <a href="#case-studies" className="block font-semibold text-gray-900 py-2">Case Studies</a>
                <a href="#careers" className="block font-semibold text-gray-900 py-2">Careers</a>
      ...
      <section className="relative pt-32 pb-20 px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-100/50 via-transparent to-violet-100/50" />
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold bg-gradient-to-r from-purple-900 via-violet-700 to-purple-900 bg-clip-text text-transparent leading-tight">
                ...
                <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl border border-purple-200 shadow-2xl p-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    {services.map((service, idx) => (
                      <div
                        key={service.name}
                        className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-purple-50 to-violet-50 border border-purple-100 hover:shadow-lg transition-all duration-300 group cursor-pointer"
      ...
      <section id="case-studies" className="py-20 px-6 lg:px-8 bg-gradient-to-br from-purple-50 to-violet-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full text-purple-700 font-semibold text-sm mb-4 shadow-sm">
              Proven Results
            </div>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Success Stories
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Real impact, measurable outcomes. See how we've helped businesses transform.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {caseStudies.map((study, idx) => (
              <div
                key={idx}
                className="bg-white rounded-2xl border border-purple-100 p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
              >
                <div className="inline-block px-3 py-1 bg-purple-100 rounded-full text-purple-700 text-sm font-semibold mb-4">
                  {study.industry}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-4">{study.company}</h3>
                <p className="text-gray-700 mb-4">{study.result}</p>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-6 lg:px-8 bg-gradient-to-br from-purple-900 via-violet-900 to-purple-900 text-white">
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#services" className="hover:text-purple-400 transition-colors">Cybersecurity</a></li>
                <li><a href="#services" className="hover:text-purple-400 transition-colors">Digital Transformation</a></li>
                <li><a href="#services" className="hover:text-purple-400 transition-colors">Managed IT</a></li>
              </ul>
            </div>
